...
class ResearchPaperConfidenceCalculator:
    """Confidence calculation method from research paper"""
...
class SingleRoleERNIEClient:
    """Single-role ERNIE-4.5 model client class - User Experience Designer only"""
    ...
    def __init__(self, name: str = "ERNIE-4.5", model_name: str = "baidu/ERNIE-4.5-300B-A47B"):
        ...
        # Define only the User Experience Designer role
        self.role = {
            "name": "User Experience Designer",
            "system_prompt": """You are a User Experience Designer, focusing on user interaction, interface design, and user experience optimization. You analyze requirements from the perspectives of user journey, interaction design, usability, accessibility, and emotional design. You focus on how requirements affect user satisfaction, ease of use, learning curve, and overall user experience. Your analysis emphasizes how requirements are "perceived and used by users".
...
4. Provide clear analysis reasoning""",
        ...
        print(f"✅ Successfully created single-role ERNIE-4.5 model client: {self.name}")
        ...
        print(f"  API configuration: SiliconFlow - ERNIE-4.5")
    ...
    def single_vote(self, text: str, labels: List[str], attempt_num: int = 1) -> Dict:
        ...
        try:
            ...
            # Call ERNIE-4.5 API (via SiliconFlow)
    ...
    def _extract_disagreement_reason(self, text: str, model_label: str, human_label: str, attempts: List[Dict]) -> str:
        ...
        try:
            ...
            return f"UX Designer analyzed from user experience perspective as '{model_label}', while human annotation is '{human_label}'. After {len(attempts)} attempts, perspective differences remain."
...
class SingleRoleProcessor:
    ...
    def __init__(self, single_role_client: SingleRoleERNIEClient):
    ...
    def _save_detailed_report(self, results: List[DataPoint], output_file: str):
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            f.write("=" * 80 + "\n")
            f.write("ERNIE-4.5 Model - User Experience Designer Single-Role Classification System Analysis Report\n")
    ...
    def print_statistics(self, results: List[DataPoint]):
        ...
        print(f"\n{'=' * 60}")
        print("📊 ERNIE-4.5 Model - User Experience Designer Single-Role Classification Statistics")
...
def main():
    ...
    output_file = "ernie_UXDesigner_retry_mechanism.xlsx"

    data_loader = DataLoader()

    print("=" * 80)
    print("🎨 ERNIE-4.5 Model - User Experience Designer Single-Role Classification System")
    ...
    if api_key:
        print(f"✅ SILICON_FLOW_API_KEY is set (length: {len(api_key)})")
    else:
        print(f"❌ SILICON_FLOW_API_KEY is not set")
        print(f"💡 Please set the environment variable SILICON_FLOW_API_KEY")
        return

    if base_url:
        print(f"✅ SILICON_FLOW_BASE_URL is set")
    else:
        print(f"❌ SILICON_FLOW_BASE_URL is not set")
        print(f"💡 Please set the environment variable SILICON_FLOW_BASE_URL")
        print(f"💡 Usually: https://api.siliconflow.cn/v1")
        return
    ...
    try:
        # Create single-role ERNIE-4.5 model client
        print(f"\n🚀 Creating single-role model client...")
        single_role_client = SingleRoleERNIEClient(
            name="ERNIE-4.5-UXDesigner",
    ...
    print(f"\n🚀 Starting ERNIE-4.5 Model UX Designer Single-Role Classification Processing...")
    ...
    print(f"\n{'=' * 80}")
    print("🎉 ERNIE-4.5 Model UX Designer Single-Role Classification Processing Complete!")
