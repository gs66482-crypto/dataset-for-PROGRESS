...
class SingleRoleGLMClient:
    """Single-role GLM model client class - Only User Experience Designer"""

    def __init__(self, name: str = "glm-4.5", model_name: str = "glm-4.5"):
        self.name = name
        self.model_name = model_name

        # GLM API configuration - using Alibaba Cloud DashScope
        ...
        print(f"✅ Successfully created single-role GLM model client: {self.name}")
        ...
        print(f"  API configuration: Alibaba Cloud DashScope")
    ...
    def single_vote(self, text: str, labels: List[str], attempt_num: int = 1) -> Dict:
        ...
        try:
            ...
            # Call GLM API - streaming mode must be enabled
            completion = self.client.chat.completions.create(
                ...
                temperature=0.3,
                max_tokens=200,
                stream=True  # GLM-4.5 only supports streaming mode
            )
...
class SingleRoleProcessor:
    ...
    def _save_detailed_report(self, results: List[DataPoint], output_file: str):
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            f.write("=" * 80 + "\n")
            f.write("GLM-4.5 Model - User Experience Designer Single-Role Classification System Analysis Report\n")
    ...
    def print_statistics(self, results: List[DataPoint]):
        """Print statistics"""
        print(f"\n{'=' * 60}")
        print("📊 GLM-4.5 Model - User Experience Designer Single-Role Classification Statistics")
...
def main():
    ...
    output_file = "glm_UXDesigner_retry_mechanism.xlsx"

    data_loader = DataLoader()

    print("=" * 80)
    print("🎨 GLM-4.5 Model - User Experience Designer Single-Role Classification System")
    ...
    print(f"\n🚀 Starting GLM-4.5 Model UX Designer single-role classification processing...")
    ...
    print(f"\n{'=' * 80}")
    print("🎉 GLM-4.5 Model UX Designer single-role classification processing completed!")
