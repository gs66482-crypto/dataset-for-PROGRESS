...
class SingleRoleProcessor:
    ...
    def _save_detailed_report(self, results: List[DataPoint], output_file: str):
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            f.write("=" * 80 + "\n")
            f.write("GLM-4.5模型-User Experience Designer单角色分类系统分析报告\n")
    ...
    def print_statistics(self, results: List[DataPoint]):
        """打印统计信息"""
        print(f"\n{'=' * 60}")
        print("📊 GLM-4.5模型-User Experience Designer单角色分类统计信息")
...
def main():
    ...
    print("=" * 80)
    print("🎨 GLM-4.5模型-User Experience Designer单角色分类系统")
    ...
    print(f"\n{'=' * 80}")
    print("🎉 GLM-4.5模型UX Designer单角色分类处理完成!")
