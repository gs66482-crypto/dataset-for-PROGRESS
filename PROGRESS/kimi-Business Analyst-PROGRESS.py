...
class SingleRoleKimiClient:
    """Single-role Kimi model client class - Business Analyst only"""

    def __init__(self, name: str = "Moonshot-Kimi-K2-Instruct", model_name: str = "kimi-k2-turbo-preview"):
        self.name = name
        self.model_name = model_name
        self.confidence_calculator = ResearchPaperConfidenceCalculator()

        # Kimi API configuration - using Moonshot
        ...
        # Define only the Business Analyst role
        self.role = {
            "name": "Business Analyst",
            "system_prompt": """You are a Business Analyst, focusing on requirements analysis, process optimization, and solution design. You analyze requirements from the perspectives of business processes, functional specifications, requirements completeness, and consistency. You focus on the clarity of requirements, testability, consistency with existing systems, and how to best meet business objectives. Your analysis emphasizes "what" needs to be built and how to meet business requirements.

Please analyze according to the following requirements:
1. Conduct in-depth analysis of requirements from a business analysis perspective
...
4. Provide clear analysis reasoning""",
        ...
        print(f"✅ Successfully created single-role Kimi model client: {self.name}")
        ...
        print(f"  API configuration: Moonshot - Kimi-K2")
    ...
    def _extract_disagreement_reason(self, text: str, model_label: str, human_label: str, attempts: List[Dict]) -> str:
        ...
        try:
            ...
            return f"Business Analyst analyzed from business analysis perspective as '{model_label}', while human annotation is '{human_label}'. After {len(attempts)} attempts, perspective differences remain."
...
class SingleRoleProcessor:
    """Single-role model processor - Business Analyst only"""

    def __init__(self, single_role_client: SingleRoleKimiClient):
    ...
    def process_dataset(self, dataset_with_labels: List[Dict], labels: List[str],
        ...
        print(f"🎭 Role configuration: Business Analyst")
    ...
    def _save_detailed_report(self, results: List[DataPoint], output_file: str):
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            f.write("=" * 80 + "\n")
            f.write("Kimi-K2 Model - Business Analyst Single-Role Classification System Analysis Report\n")
    ...
    def print_statistics(self, results: List[DataPoint]):
        ...
        print(f"\n{'=' * 60}")
        print("📊 Kimi-K2 Model - Business Analyst Single-Role Classification Statistics")
        ...
        print(f"Role Used: Business Analyst")
...
def main():
    ...
    output_file = "kimi_BusinessAnalyst_retry_mechanism.xlsx"

    data_loader = DataLoader()

    print("=" * 80)
    print("📊 Kimi-K2 Model - Business Analyst Single-Role Classification System")
    ...
    if api_key:
        print(f"✅ MOONSHOT_API_KEY is set (length: {len(api_key)})")
    else:
        print(f"❌ MOONSHOT_API_KEY is not set")
        print(f"💡 Please set the environment variable MOONSHOT_API_KEY")
        return
    ...
    try:
        # Create single-role Kimi model client
        print(f"\n🚀 Creating single-role model client...")
        single_role_client = SingleRoleKimiClient(
    ...
    print(f"\n🚀 Starting Kimi-K2 Model Business Analyst Single-Role Classification Processing...")
    ...
    print(f"\n{'=' * 80}")
    print("🎉 Kimi-K2 Model Business Analyst Single-Role Classification Processing Complete!")
