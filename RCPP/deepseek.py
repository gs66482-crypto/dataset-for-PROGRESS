...
class MultiRoleDeepSeekClient:
    """Multi-role DeepSeek model client class - Six professional roles based on research paper"""
    ...
    def __init__(self, name: str = "deepseek-chat", model_name: str = "deepseek-chat"):
        ...
        print(f"✅ Successfully created multi-role DeepSeek model client: {self.name}")
...
class MultiRoleProcessor:
    ...
    def __init__(self, multi_role_client: MultiRoleDeepSeekClient):
    ...
    def _save_detailed_report(self, results: List[DataPoint], output_file: str):
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            f.write("=" * 80 + "\n")
            f.write("DeepSeek Model - Six Professional Role Classification System Analysis Report\n")
            f.write("=" * 80 + "\n\n")
    ...
    def print_statistics(self, results: List[DataPoint]):
        """Print statistics"""
        print(f"\n{'=' * 60}")
        print("📊 DeepSeek Model - Six Professional Role Classification Statistics")
        print(f"{'=' * 60}")
...
def main():
    ...
    output_file = "deepseek_6_roles_confidence.xlsx"

    data_loader = DataLoader()

    print("=" * 60)
    print("🎭 DeepSeek Model - Six Professional Role Software Requirement Classification System")
    ...
    # Create multi-role DeepSeek model client
    try:
        multi_role_client = MultiRoleDeepSeekClient(
            name="DeepSeek-chat-6Roles",
    ...
    print(f"\n🚀 Starting DeepSeek model six-role classification processing...")
    ...
    print(f"\n{'=' * 60}")
    print("🎉 DeepSeek Model six-role classification processing completed!")
