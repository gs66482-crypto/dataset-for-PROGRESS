...
class MultiRoleDeepSeekClient:
    """多角色DeepSeek模型客户端类 - 基于研究论文的五种专业角色"""
    ...
    def __init__(self, name: str = "deepseek-chat", model_name: str = "deepseek-chat"):
        ...
        print(f"✅ 成功创建多角色DeepSeek模型客户端: {self.name}")
...
class MultiRoleProcessor:
    ...
    def _save_detailed_report(self, results: List[DataPoint], output_file: str):
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            f.write("=" * 80 + "\n")
            f.write("DeepSeek模型-五人专业角色分类系统分析报告\n")
            f.write("=" * 80 + "\n\n")
...
def main():
    ...
    output_file = "deepseek_5人2置信度.xlsx"

    data_loader = DataLoader()

    print("=" * 60)
    print("🎭 DeepSeek模型-五人专业角色软件需求分类系统")
