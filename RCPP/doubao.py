...
class MultiRoleDoubaoClient:
    """Multi-role Doubao model client class - Based on research paper's six professional roles"""
    ...
    def __init__(self, name: str = "doubao-seed-1-6-250615", model_name: str = "doubao-seed-1-6-250615"):
        ...
        print(f"✅ Successfully created multi-role Doubao model client: {self.name}")
...
class MultiRoleProcessor:
    ...
    def _save_detailed_report(self, results: List[DataPoint], output_file: str):
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            f.write("=" * 80 + "\n")
            f.write("Doubao Model - Six Professional Role Classification System Analysis Report\n")
            f.write("=" * 80 + "\n\n")
    ...
    def print_statistics(self, results: List[DataPoint]):
        ...
        print(f"\n{'=' * 60}")
        print("📊 Doubao Model - Six Professional Role Classification Statistics")
        print(f"{'=' * 60}")
...
def main():
    ...
    output_file = "doubao_6_roles_confidence.xlsx"

    data_loader = DataLoader()

    print("=" * 60)
    print("🎭 Doubao Model - Six Professional Role Software Requirement Classification System")
    ...
    # Create multi-role Doubao model client
    try:
        multi_role_client = MultiRoleDoubaoClient(
            name="doubao-seed-1-6-250615-6角色",
    ...
    print(f"\n🚀 Starting Doubao model six-role classification processing...")
    ...
    print(f"\n{'=' * 60}")
    print("🎉 Doubao model six-role classification processing complete!")
