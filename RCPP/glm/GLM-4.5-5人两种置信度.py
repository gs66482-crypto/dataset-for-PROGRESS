...
class MultiRoleGLMClient:
    ...
    def __init__(self, name: str = "glm-4.5", model_name: str = "glm-4.5"):
        ...
        print(f"✅ 成功创建多角色GLM模型客户端: {self.name}")
        ...
        print(f"  API配置: 阿里云DashScope (https://dashscope.aliyuncs.com/compatible-mode/v1)")
        print(f"  注意: GLM-4.5模型只支持流式模式(stream=True)")
...
class MultiRoleProcessor:
    ...
    def _save_detailed_report(self, results: List[DataPoint], output_file: str):
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            f.write("=" * 80 + "\n")
            f.write("GLM-4.5模型-五人专业角色分类系统分析报告\n")
            f.write("=" * 80 + "\n\n")
...
def main():
    ...
    output_file = "glm_5人2置信度.xlsx"

    data_loader = DataLoader()

    print("=" * 60)
    print("🎭 GLM-4.5模型-五人专业角色软件需求分类系统")
