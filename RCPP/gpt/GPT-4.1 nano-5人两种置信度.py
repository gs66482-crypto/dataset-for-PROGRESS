...
class MultiRoleGPTClient:
    ...
    def __init__(self, name: str = "gpt-4.1-nano", model_name: str = "gpt-4.1-nano"):
        ...
        print(f"✅ 成功创建多角色GPT模型客户端: {self.name}")
        ...
        print(f"  注意: GPT-4.1-nano模型只支持流式模式(stream=True)")
            ...
            for attempt in range(3):  # 重试机制
                try:
                    ...
                    completion = self.client.chat.completions.create(
                        ...
                        temperature=0.3,
                        max_tokens=200,
                        stream=True  # GPT-4.1-nano只支持流式模式
                    )
...
class MultiRoleProcessor:
    ...
    def _save_detailed_report(self, results: List[DataPoint], output_file: str):
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            f.write("=" * 80 + "\n")
            f.write("GPT-4.1-nano模型-五人专业角色分类系统分析报告\n")
            f.write("=" * 80 + "\n\n")
    ...
    def print_statistics(self, results: List[DataPoint]):
        """打印统计信息"""
        print(f"\n{'=' * 60}")
        print("📊 GPT-4.1-nano模型五人专业角色分类统计信息")
        print(f"{'=' * 60}")
...
def main():
    ...
    output_file = "gpt_5人2置信度.xlsx"

    data_loader = DataLoader()

    print("=" * 60)
    print("🎭 GPT-4.1-nano模型-五人专业角色软件需求分类系统")
    ...
    print(f"\n{'=' * 60}")
    print("🎉 GPT-4.1-nano模型五人角色分类处理完成!")
