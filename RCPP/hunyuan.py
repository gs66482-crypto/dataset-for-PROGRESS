...
class MultiRoleHunyuanClient:
    """Multi-role Tencent Hunyuan model client class - Six professional roles based on research paper"""
    ...
    def __init__(self, name: str = "Tencent Hunyuan", model_name: str = "hunyuan-turbos-latest"):
        ...
        print(f"✅ Successfully created multi-role Tencent Hunyuan model client: {self.name}")
    ...
    def _call_hunyuan_api(self, messages: List[Dict], temperature: float = 0.3, max_tokens: int = 200) -> str:
        ...
        try:
            ...
            raise Exception(f"Failed to call Tencent Hunyuan API: {str(e)}")
        ...
        for role_key, role_info in self.roles.items():
            ...
            for attempt in range(3):  # Retry mechanism
                try:
                    ...
                    # Call Tencent Hunyuan API
                    response_content = self._call_hunyuan_api(
                        messages=[
...
class MultiRoleProcessor:
    ...
    def __init__(self, multi_role_client: MultiRoleHunyuanClient):
    ...
    def _save_detailed_report(self, results: List[DataPoint], output_file: str):
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            f.write("=" * 80 + "\n")
            f.write("Tencent Hunyuan Model - Six Professional Role Classification System Analysis Report\n")
            f.write("=" * 80 + "\n\n")
    ...
    def print_statistics(self, results: List[DataPoint]):
        """Print statistics"""
        print(f"\n{'=' * 60}")
        print("📊 Tencent Hunyuan Model - Six Professional Role Classification Statistics")
        print(f"{'=' * 60}")
...
def main():
    ...
    output_file = "hunyuan_6_roles_confidence.xlsx"

    data_loader = DataLoader()

    print("=" * 60)
    print("🎭 Tencent Hunyuan Model - Six Professional Role Software Requirement Classification System")
    ...
    # Create multi-role Tencent Hunyuan model client
    try:
        multi_role_client = MultiRoleHunyuanClient(
            name="Tencent Hunyuan-6Roles",
    ...
    print(f"\n🚀 Starting Tencent Hunyuan model six-role classification processing...")
    ...
    print(f"\n{'=' * 60}")
    print("🎉 Tencent Hunyuan Model six-role classification processing completed!")
