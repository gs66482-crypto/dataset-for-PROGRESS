...
class MultiRoleHunyuanClient:
    ...
    def __init__(self, name: str = "腾讯混元", model_name: str = "hunyuan-turbos-latest"):
        ...
        print(f"✅ 成功创建多角色腾讯混元模型客户端: {self.name}")
    ...
    def _call_hunyuan_api(self, messages: List[Dict], temperature: float = 0.3, max_tokens: int = 200) -> str:
        ...
        try:
            ...
            raise Exception(f"调用腾讯混元API失败: {str(e)}")
...
def main():
    ...
    output_file = "hunyuan_5人2置信度.xlsx"

    data_loader = DataLoader()

    print("=" * 60)
    print("🎭 腾讯混元模型-五人专业角色软件需求分类系统")
